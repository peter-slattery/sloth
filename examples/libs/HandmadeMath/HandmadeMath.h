...
{
  return (hmm_vec2){
    .X = HMM_Lerp(A.X, T, B.X),
    .Y = HMM_Lerp(A.Y, T, B.Y),
  };
}
HINLINE hmm_vec3
...
{
  hmm_v2 Result = {
    .x = Range.ValueMax.x - Range.ValueMin.x,
    .y = Range.ValueMax.y - Range.ValueMin.y
  };
  return Result;
}
...
{
  hmm_v2r Result = {
    .ValueMin = HMM_AddVec2(Range.ValueMin, Offset),
    .ValueMax = HMM_AddVec2(Range.ValueMax, Offset),
  };
  return Result;
}
...
static hmm_vec4
HMM_AverageVec3(hmm_vec4* Arr, unsigned int Len)
{
  hmm_vec4 Total = {};
  for (int i = 0; i < Len; i++) 
  {
...
static hmm_vec4
HMM_AverageVec4(hmm_vec4* Arr, unsigned int Len)
{
  hmm_vec4 Total = {};
  for (int i = 0; i < Len; i++) 
  {
